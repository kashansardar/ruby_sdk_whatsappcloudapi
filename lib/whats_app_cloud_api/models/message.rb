...
module WhatsAppCloudApi
  ...
  class Message < BaseModel
    ...
    def self.types
      ...
      @_types['audio'] = 'Audio'
      @_types['contacts'] = 'Contact[]'
      @_types['document'] = 'Document'
      @_types['image'] = 'Image'
      @_types['interactive'] = 'Interactive'
      @_types['location'] = 'Location'
      @_types['messaging_product'] = 'String'
      @_types['recipient_type'] = 'String'
      @_types['sticker'] = 'Sticker'
      @_types['template'] = 'Template'
      @_types['text'] = 'Text'
      @_types['to'] = 'String'
      @_types['type'] = 'MessageTypeEnum'
      @_types['video'] = 'Video'
      @_types
    end
    ...
    def self.from_hash(hash)
      ...
      names.each do |key, value|
        has_default_value = %w[recipient_typ].include? key
