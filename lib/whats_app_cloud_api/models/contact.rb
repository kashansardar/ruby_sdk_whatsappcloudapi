...
module WhatsAppCloudApi
  ...
  class Contact < BaseModel
    ...
    def self.types
      ...
      @_types['addresses'] = 'Address[]'
      @_types['birthday'] = 'String'
      @_types['emails'] = 'EmailObject[]'
      @_types['name'] = 'Name'
      @_types['org'] = 'Org'
      @_types['phones'] = 'PhoneObject[]'
      @_types['urls'] = 'UrlObject[]'
      @_types
    end
    ...
    def self.from_hash(hash)
      ...
      names.each do |key, value|
        has_default_value = %w[birthda].include? key
